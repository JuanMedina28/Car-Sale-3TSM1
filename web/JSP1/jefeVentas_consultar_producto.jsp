    ...
    <body>
        <header class="header">
            ...
            <div class="alert alert-primary" role="alert" style="width: 50%; margin-left: 25%;">
                <h3 style="margin-left: 20%">Productos registrados:</h3>
                <a href="index_jefes.jsp"><button type="button" class="btn btn-dark" style="margin-left: 60%; margin-top: -7%; height: 40px;">Regresar</button></a>
            </div>
                ...
                <table class="table table-hover table-dark" style="position: absolute; width: 85%; margin-left: 7.5%;">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; font-size: 20px;">Contenido</th>
                            <th style="text-align: center; font-size: 20px;">Cantidad</th>
                            <th style="text-align: center; font-size: 20px;">Pecio</th>
                            <th style="text-align: center; font-size: 20px;">Detalles</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; font-size: 15px;">Motor</td>
                            <td style="text-align: center; font-size: 15px;">1 pz</td>
                            <td style="text-align: center; font-size: 15px;">16 pz</td>
                            <td style="text-align: center; font-size: 15px;">$100000</td>
                            <td style="text-align: center; font-size: 15px;">Material Fragil</td>
                            <td style="text-align: center; font-size: 15px;"><a href="jefeVentas_modificar_producto.jsp"><img src="../Icons/ic_create_white_36dp.png"></a></td>
