            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-lg p-3 mb-5 bg-white">
                        <%
                            ...
                            if(email1!=null & puesto1!=null & area1!=null){
                                if(email1.equals(correo)){
                                    ...
                                    response.sendRedirect("jefes_consultar_empleados.jsp");
                        ...
                        <div class="card-body">
                            <form id="form1" action="jefes_modificar_empleados.jsp?id_emple=<% out.print(info1.getString("id_usuario")); %>" method="post" class="needs-validation">
                                <div class="form-row">
