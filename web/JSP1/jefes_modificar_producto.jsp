                    ...
                    <div class="card shadow-lg p-3 mb-5 bg-white">
                        ...
                        <div class="card-body">
                            <%
                                ...
                                datos1.next();
                            %>
                            <form name="form1" id="form1" action="jefes_modificar_producto.jsp?id_producto=<% out.print(datos1.getString("id_producto")); %>" method="post" class="needs-validation" onsubmit="return validar();">
                                <div class="form-row">
                            ...
                            <a href="jefes_consultar_productos.jsp"><button type="button" class="btn btn-dark"  style="width: 20%; margin-left: 30%; margin-top: -8%">Regresar</button></a>
                        </div>
                    </div>
                </div>
            </div>
