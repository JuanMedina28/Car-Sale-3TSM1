<%-- 
    Document   : consultar_servicios
    Created on : 2 abr. 2020, 14:26:55
    Author     : asant
--%>
...
<html>
    ...
    <body>
        <header class="header">
            ...
            <div class="alert alert-primary" role="alert" style="width: 50%; margin-left: 25%;"><h4 style="margin-left: 15%;">Tipo de servicio:</h4>
                <form action="consultas-empleados.html" method="post">
                    <select class="form-control form-control-sm" style="width: 30%; margin-left: 15%; margin-top: 2%;" name="filtro">
                        ...
                        <option value="Ventas">Estetico</option>
                        <option value="Almacen">Motor</option>
                    </select>
            ...
            <div style="display: inline-table">
                <table class="table table-hover table-dark" style="position: absolute; width: 85%; margin-left: 7.5%;">
                    <thead>
                        <tr>
                            <th scope="col"></th>
                            <th colspan="5" style="font-size: 20px; text-align: left">Informacion del servicio</th>
                            <th scope="col" style="font-size: 20px; text-align: right">Modificar</th>
                        </tr>
                        <tr>
                            <th scope="col">#</th>
                            ...
                            <th scope="col"><a href="../JSP1/modificar_servicios.jsp">Editar</a></th>
                        </tr>
                    </thead>
                    </tbody>
                </table>
