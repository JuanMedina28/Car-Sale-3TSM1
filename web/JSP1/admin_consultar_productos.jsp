    ...
    <body>
        <header class="header">
            ...
            <div class="alert alert-primary" role="alert" style="width: 50%; margin-left: 25%;"><h4 style="margin-left: 15%;">Buscar por campo:</h4>
                <form action="admin_consultar_empleados.jsp" method="post">
                ...
                <table class="table table-hover table-dark" style="width: 150%; margin-left: 40%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="admin_modificar_producto.jsp?id_producto=<% out.print(datos1.getString("id_producto")); %>"><img src="../Icons/ic_create_white_36dp.png"></a></td>
                        </tr>
                        <% }%>
                    </tbody>
                </table>
